...
PERMISSIONS = {
    ROLE_ADMIN: ["dashboard", "performance", "settings", "user_management", "oos_analysis", "conquete_territoire", "gros_transferts", "pos_non_touches", "pos_commercial", "relationship_map"],
