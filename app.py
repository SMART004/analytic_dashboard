...
with st.sidebar:
    selected = option_menu(
        ...
        options=["Dashboard", "Conquête de Territoire", "Analyse Gros Transferts", "Analyse des POS non Touche", "Performance Commerciaux", "Performance POS relais & Caisses", "Performance CDS","POS par Commercial", "Listing OOS", "Settings"],
        icons=["house-fill", "trophy", "cash-stack", "box-seam", "graph-up-arrow", "graph-up-arrow", "graph-up-arrow", "people-fill", "box-seam", "gear-fill"],
